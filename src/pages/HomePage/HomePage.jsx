      			...
      			<div className="main">
          					...
          					<div className="container">
            						...
            						<div className="backgroundbordershadow">
              							...
              							<div className="div">
                								...
                								<p className="p">для сохранения ваших</p>
                								<p className="p">расчетов</p>
              							</div>
            						</div>
            						<div className="backgroundbordershadow1">
              							...
              							<div className="div1">
                								...
                								<p className="p">деятельности для точного</p>
                								<p className="p">расчета</p>
              							</div>
            						</div>
            						<div className="backgroundbordershadow2">
              							...
              							<div className="div2">
                								...
                								<p className="p">рабочих днях и больничных</p>
              							</div>
            						</div>
            						<div className="backgroundbordershadow3">
              							...
              							<div className="div3">
                								...
                								<p className="p">с учетом всех нюансов</p>
              							</div>
            						</div>
          					</div>
        				</div>
        				...
        				<div className="section2">
          					<div className="container1">
            						<b className="heading-21">Готовы рассчитать вашу зарплату?</b>
              							<div className="container2">
                								<div className="div8">
                  									<p className="p">Получите точный расчет с учетом всех нюансов вашей профессии, включая</p>
                  									<p className="p">больничные и отпускные</p>
                								</div>
              							</div>
              							<div className="link">
                								<div className="div9">Начать бесплатный расчет</div>
              							</div>
              							</div>
              							</div>
              							<div className="section3">
                								<div className="heading-1">
                  									<b className="b">
                    										<p className="p">Умный расчёт зарплаты</p>
                    										<p className="p">и больничных</p>
                  									</b>
                								</div>
                								<div className="div10">Быстро. Точно. Для всех профессий</div>
                								<div className="link1">
                  									<div className="div11">Начать расчёт</div>
                								</div>
              							...
              							<div className="footer">
                								<div className="container3">
                  									<div className="heading-34">Calcora</div>
                  									<div className="div12">
              							...
              							<div className="nav">
                								...
                								<div className="link9">
                  									<div className="div19">Войти</div>
                								</div>
                								<div className="link10">
                  									<div className="div20">Зарегистрироваться</div>
                								</div>
              							</div>
              							</div>);
            						};
